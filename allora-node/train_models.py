...
def create_features(data_frame):
    """
    Membuat fitur teknikal dengan menghindari lookahead bias
    """
    df_temp = data_frame.copy()
    
    # Gunakan .shift() untuk semua fitur momentum
    ...
    # Technical indicators dengan min_periods=1
    # MACD
...
def prepare_data_for_log_return(data_df, look_back=60, prediction_horizon=480):
    ...
    # PERBAIKAN: Split data TERLEBIH DAHULU sebelum feature engineering
    ...
    # PERBAIKAN: Feature engineering dilakukan secara terpisah
...
def train_and_save_xgb_model(token_name, X_train, Y_train, X_test, Y_test, prev_Y_test, scaler, prediction_horizon):
    ...
    # PERBAIKAN: Gunakan TimeSeriesSplit yang benar
    ...
    search = BayesSearchCV(
        pipeline, param_space, n_iter=15, cv=tscv,
...
def train_log_return_models(token_name, look_back=60, prediction_horizon=480, hours_data=None):
    ...
    try:
        ...
        scaler_xgb = MinMaxScaler(feature_range=(-1, 1))
